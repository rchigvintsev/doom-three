...
export class JSONLoader {
    ...
    parse = (() => {
        ...
        return (json, texturePath) => {
            ...
            if (json.materials == null || json.materials.length === 0) {
                ...
                const materials = this._initMaterials(json.materials, texturePath, this.crossOrigin);
                return {geometry: geometry, materials: materials};
            }
        };
    })();

    _initMaterials(materials, texturePath, crossOrigin) {
        const array = [];
        for (let i = 0; i < materials.length; i++) {
            array[i] = this._createMaterial(materials[i], texturePath, crossOrigin);
        }
        return array;
    }
    ...
    _createMaterial = (() => {
        ...
        return (m, texturePath, crossOrigin) => {
            ...
            const json = {uuid: THREE.Math.generateUUID(), type: 'MeshLambertMaterial'};
            ...
            for (const name of Object.keys(m)) {
                ...
                switch (name) {
                    ...
                    case 'colorAmbient':
                    case 'mapAmbient':
                        console.warn('JSONLoader._createMaterial: ' + name + 'is no longer supported');
                        break;
                    case 'colorDiffuse':
                    ...
                    case 'shading':
                        ...
                        break;
                    case 'mapDiffuse':
                        json.map = loadTexture(value, m.mapDiffuseRepeat, m.mapDiffuseOffset, m.mapDiffuseWrap,
                    ...
                    case 'mapDiffuseAnisotropy':
                        break;
                    case 'mapEmissive':
                        json.emissiveMap = loadTexture(value, m.mapEmissiveRepeat, m.mapEmissiveOffset,
                            m.mapEmissiveWrap, m.mapEmissiveAnisotropy);
                        break;
                    ...
                    case 'mapEmissiveAnisotropy':
                        break;
                    case 'mapLight':
                        json.lightMap = loadTexture(value, m.mapLightRepeat, m.mapLightOffset, m.mapLightWrap,
                    ...
                    case 'mapAOAnisotropy':
                        break;
                    case 'mapBump':
                        json.bumpMap = loadTexture(value, m.mapBumpRepeat, m.mapBumpOffset, m.mapBumpWrap,
                            m.mapBumpAnisotropy);
                        break;
                    case 'mapBumpScale':
                    ...
                    case 'mapBumpAnisotropy':
                        break;
                    case 'mapNormal':
                        json.normalMap = loadTexture(value, m.mapNormalRepeat, m.mapNormalOffset, m.mapNormalWrap,
                    ...
                    case 'mapNormalAnisotropy':
                        break;
                    case 'mapSpecular':
                        json.specularMap = loadTexture(value, m.mapSpecularRepeat, m.mapSpecularOffset,
                    ...
                    case 'mapSpecularAnisotropy':
                        break;
                    case 'mapMetalness':
                        json.metalnessMap = loadTexture(value, m.mapMetalnessRepeat, m.mapMetalnessOffset,
                            m.mapMetalnessWrap, m.mapMetalnessAnisotropy);
                        break;
                    ...
                    case 'mapMetalnessAnisotropy':
                        break;
                    case 'mapRoughness':
                        json.roughnessMap = loadTexture(value, m.mapRoughnessRepeat, m.mapRoughnessOffset,
                            m.mapRoughnessWrap, m.mapRoughnessAnisotropy);
                        break;
                    ...
                    case 'mapRoughnessAnisotropy':
                        break;
                    case 'mapAlpha':
                        json.alphaMap = loadTexture(value, m.mapAlphaRepeat, m.mapAlphaOffset, m.mapAlphaWrap,
                    ...
                    case 'doubleSided':
                        ...
                        break;
                    case 'transparency':
                        console.warn('JSONLoader._createMaterial: transparency has been renamed to opacity');
                        json.opacity = value;
                        break;
                    case 'depthTest':
                    case 'depthWrite':
                    ...
                    case 'vertexColors':
                        ...
                        break;
                    default:
                        console.error('JSONLoader._createMaterial: unsupported [' + name + ' = ' + value + ']');
                        break;
                }
            }
