export const SOUNDS = {
    elevator_inner_door: {
        type: 'positional',
        sources: ['sound/ed/doors/_elevator_silver_twopaned/inner_1.ogg']
    },
    elevator_outer_open: {
        type: 'positional',
        sources: ['sound/ed/doors/_elevator_silver_twopaned/open1.ogg']
    },
    elevator_outer_close: {
        type: 'positional',
        sources: ['sound/ed/doors/_elevator_silver_twopaned/close1.ogg']
    },
    player_sounds_footsteps: {
        type: 'plain',
        sources: [
    ...
    player_sounds_jump_small: {
        type: 'plain',
        sources: ['sound/ed/player/jump1_alt3.ogg']
    },
    ...
    fist_raise: {
        type: 'plain',
        sources: ['sound/weapons/fists/raise_fists_01.wav']
    },
    fist_whoosh: {
        type: 'plain',
        sources: [
